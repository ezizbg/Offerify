    ...
    <div className={styles.root}>
      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          <a href="/" className={styles.wordmark} aria-label="Offerify">
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true">
              <circle cx="10" cy="10" r="9" stroke="currentColor" strokeWidth="1.5" className={styles.logoCircle} />
              <path d="M6.5 10h7M10 6.5l3.5 3.5-3.5 3.5" stroke="currentColor" strokeWidth="1.5"
                strokeLinecap="round" strokeLinejoin="round" className={styles.logoArrow} />
            </svg>
            Offerify
          </a>

          <a href="https://github.com/ezizbg/Offerify" target="_blank"
            rel="noopener noreferrer" className={styles.headerLink} aria-label="GitHub">
      ...
      <section className={styles.hero}>
        {/* Точечная сетка — за текстом, fade к низу */}
        ...
        <div className={styles.heroInner}>
          ...
          <h1 className={styles.heroTitle}>
            AI tools for<br />
            <span className={styles.heroGradient}>modern hiring.</span>
          </h1>

          <p className={styles.heroSub}>
            Generate cover letters, write job descriptions,<br className={styles.heroBr} />
            and analyze resume fit — in seconds.
          </p>

          {/* Три фичи одной строкой */}
          <div className={styles.heroFeatures}>
            {["Cover Letters", "Job Descriptions", "Resume Analysis"].map((f) => (
              <span key={f} className={styles.heroFeature}>
                <span className={styles.heroFeatureDot} aria-hidden="true" />
                {f}
              </span>
            ))}
          </div>
